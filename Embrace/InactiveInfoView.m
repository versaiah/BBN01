...
- (void)viewDidLoad {
    ...
    btnEnable.frame = CGRectMake(btnRename.frame.origin.x + btnRename.frame.size.width + 5, 190, 400 * sg, 150 * sg);
    ...
    btnRemove.frame = CGRectMake(btnEnable.frame.origin.x + btnEnable.frame.size.width + 5, 190, 400 * sg, 150 * sg);
